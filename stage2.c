		...
		if(collision(poshero,postrap1)==1&&directionhero==1)
		{
		     ...
		     Mix_PlayChannel( -1, dying, 0 ) ;
            		heroactu=hurt;
	        			...
	        			SDL_BlitSurface(surfaceminutes, NULL, ecran, &posminutes);			        SDL_BlitSurface(barre, NULL, ecran, &posbarre);
