...
#define speed  6
#define TEMPS 30
void stage2s(SDL_Surface *ecran,int *continuer,Mix_Music *intro,Mix_Chunk *effet,Mix_Chunk *effet2,Mix_Music *musique,int *mute,SDL_Rect *posvolb,Mix_Chunk *sonspell,Mix_Chunk *dying,Mix_Chunk *hit,int *victory)
{
	SDL_Surface *health=NULL,*scoreS=NULL,*load=NULL,*Rotation=NULL,*Rotation2=NULL,*Rotation3=NULL,*Rotation4=NULL,*portal=NULL,*ninja=NULL,*shiled=NULL,*shiledr=NULL,*shiledl=NULL,*paragstage1=NULL,*magicien=NULL,*noir=NULL,*gameover=NULL,*attackr=NULL,*attackl=NULL,*hurt=NULL,*rock1=NULL,*rock2=NULL,*spell=NULL,*spellen=NULL,*vie=NULL, *trap1=NULL,*background=NULL,*petithero=NULL,*magicienpetit=NULL,*petithero2=NULL,*petitherog=NULL,*barre=NULL,*herod=NULL,*herog=NULL,*heroactu=NULL,*hpup=NULL,*police=NULL,*enemie=NULL,*enemied=NULL,*enemieg=NULL,*enemie1=NULL,*enemied1=NULL,*enemieg1=NULL,*enematack=NULL,*enem1atack=NULL,*score=NULL,*scoreint=NULL,
	*idlel=NULL,*idler=NULL,*terre1=NULL,*terre2=NULL,*terre3=NULL,*jumpr=NULL,*jumpl=NULL,*surfacesecondes=NULL,*surfaceminutes=NULL
	...
	posscoreint,postrap1,frame4[8],posbarre,posload,pospetithero,posmagicienpetit,posterre1,posterre2,posterre3,posterre4,posterre5,posterre6,posterre7,posterre8,posterre9,postime,posenigme1,posparagstage1;
...
double angle=0, zoom=1;
	...
	char minutes[2];
	Mix_Music *stage1;
	paragstage1=IMG_Load("image/histoire/stage2.png");
	noir=IMG_Load("image/histoire/black.png");
	stage1 = Mix_LoadMUS("music/stage1.mp3");
	Mix_PlayMusic(stage1, -1);
	posload.x=350;
	posload.y=150;
	load=IMG_Load("image/stage/load2.png");
	SDL_FillRect(ecran, NULL, SDL_MapRGB(ecran->format, 0, 0, 0));
	SDL_BlitSurface(load,NULL,ecran,&posload);
	SDL_Flip(ecran);
	SDL_Delay(3000);
...
charger2(&poshero.x,&posmagicien.x,&posenigme1.x,&poshpup.x,&posback.x,&pospolice.x,&pose1,&pose2,&pose3,&pose4,&pose5,&pose6,&pose7,&posrock1.x,&postrap1.x,&posterre3.x,&posterre1.x,&posterre2.x,&posterre4.x,&posterre5.x,&posterre6.x,&posterre7.x,&posterre8.x,&posterre9.x,&camera,continuer,&stage,&tsec,&tmin,&hp,&cmpsc,&posninja.x,&pose8,&poshpup1.x,&posninjaa.x);
	...
	possecondes.x=500;
	possecondes.y=25;
	pospetithero.x=((-posback.x*500) / 9500) + 800;
	posportal.x=0;
	posportal.y=0;
	...
	enigmestage1=IMG_Load ("image/enigme/bulle00.png");
	...
	while ((boucle)&&((*continuer)))
        ...
        scoreint=TTF_RenderText_Blended(fonts,scr, couleur);
       		...
       		switch(event.type)
        	{
				...
				break;
case SDLK_ESCAPE:	Pause2(ecran,&poshero.x,&posmagicien.x,&posenigme1.x,&poshpup.x,&posback.x,&pospolice.x,&posenemie1,&posenemie2,&posenemie3,&posenemie4,&posenemie5,&posenemie6,&posenemie7,&posrock1.x,&postrap1.x,&posterre3.x,&posterre1.x,&posterre2.x,&posterre4.x,&posterre5.x,&posterre6.x,&posterre7.x,&posterre8.x,&posterre9.x,&camera,continuer,tsec,tmin,hp,cmpsc,&posninja.x,&pose8,&poshpup1.x,&posninjaa.x,&boucle);
				break;
				case SDLK_m:
...
SDL_BlitSurface(barre, NULL, ecran, &posbarre);
	        SDL_BlitSurface(petithero2, &frame4[w/4], ecran, &pospetithero);
	        SDL_BlitSurface(magicienpetit, &frame4[w/4], ecran, &posmagicienpetit);	
   	    	                        SDL_Flip(ecran);
            			}
		}
